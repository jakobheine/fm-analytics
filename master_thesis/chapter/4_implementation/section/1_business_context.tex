...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=7cm]{chapter/9_misc/figures/ranking.png}}
...
\begin{figure}[htp]
    \makebox[\textwidth][c]{
        \fbox{
            \includegraphics[width=.38\textwidth]{chapter/9_misc/figures/first_place.png}\hfill
            \includegraphics[width=.38\textwidth]{chapter/9_misc/figures/second_place.png}\hfill
            \includegraphics[width=.38\textwidth]{chapter/9_misc/figures/third_place.png}
        }
    }
    \captionsetup{justification=centering}
