...
As already mentioned in the previous chapter, SPITCH is a provider for fantasy soccer leagues. \parencite[cf.][]{spitch_spitch_nodate} At the beginning of writing, SPITCH only provided competitions for the German \emph{Bundesliga}. Until now, numerous national football associations from different countries joined. Furthermore, football managers can these days compete in various other game modes. This thesis solely deals with the traditional game mode for the German \emph{Bundesliga}. \\
